...
<form className="w-72">   
    ...
    <div className="relative">
        ...
        <input type="search" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required />
    </div>
</form>
        ...
        <div className="mx-auto max-w-7xl px-2 bg-white">
          <div className="relative flex h-10 items-center justify-between">
            <div className="flex flex-1 items-center justify-start">
                <div className="flex">
                  <a href="#" className="text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Aluminum</a>
                  <a href="#" className="text-white rounded-md px-3 py-2 text-sm font-medium">Stainless Steel</a>
                  <a href="#" className="text-white rounded-md px-3 py-2 text-sm font-medium">Steel</a>
                  <a href="#" className="text-white rounded-md px-3 py-2 text-sm font-medium">REM Center</a>
                </div>
            </div>
            <div className="flex flex-1 items-center justify-end">
                <div className="flex">
                 
<button type="button" className="text-white bg-light-blue hover:bg-light-blue focus:ring-4 focus:outline-none focus:ring-light-blue font-medium text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-light-blue dark:hover:bg-light-blue dark:focus:ring-light-blue">
...
<button type="button" className="text-white bg-light-blue hover:bg-light-blue focus:ring-4 focus:outline-none focus:ring-light-blue font-medium text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-light-blue dark:hover:bg-light-blue dark:focus:ring-light-blue">
    New Quote
