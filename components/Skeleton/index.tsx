...
<div role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center mt-4 ml-8">
    <div className="flex items-center justify-center w-full h-48 bg-white rounded sm:w-96 dark:bg-white">
